...
public class pdisk extends Base {
    ...
    public pdisk(Context c, AsyncResponse asyncResponse)
    {
    ...
    public void onPostExecute(Document document)
    {
        try
        {
            ...
            if(! this.videoUrl.equals("") && this.videoUrl !=null )
            {
                ...
                sb.append(mainContext.getResources().getString(R.string.pdisk_Suffix));
                sb.append(System.currentTimeMillis());
                sb.append(".mp4");
                String str3 = Utils.RootDirectorypdisk;
