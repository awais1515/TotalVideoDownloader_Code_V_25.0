...
public class Josh extends Base {

    public Josh(Context c, AsyncResponse asyncResponse)
    {
    ...
    public void onPostExecute(Document document)
    {
        try {
            ...
            if (!html.equals("")) {
                this.videoUrl = String.valueOf(new JSONObject(html).getJSONObject("props").getJSONObject("pageProps").getJSONObject("detail").getJSONObject("data").get("download_url"));
                ...
                if(! this.videoUrl.equals("") && this.videoUrl !=null )
                {
                    ...
                    sb.append(mainContext.getResources().getString(R.string.Josh_Suffix));
                    sb.append(System.currentTimeMillis());
                    sb.append(".mp4");
                    String str3 = Utils.RootDirectoryJosh;
