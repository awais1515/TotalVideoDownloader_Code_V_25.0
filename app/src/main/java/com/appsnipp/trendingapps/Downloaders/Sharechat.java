...
public class Sharechat extends Base {
    public Sharechat(Context c, AsyncResponse asyncResponse)
    {
    ...
    protected Document doInBackground(String... strings) {
        try {
                if(TextUtils. IsContainsRistriced(strings[0]))
                {
                    return null;
                }
    ...
    public void onPostExecute(Document document) {
        try
        {
            ...
            if(! this.videoUrl.equals("") && this.videoUrl !=null )
            {
                ...
                sb.append(mainContext.getResources().getString(R.string.ShareChat_Suffix));
                sb.append(System.currentTimeMillis());
                sb.append(".mp4");
                String str3 = Utils.RootDirectoryShareChat;
        ...
        {
            DownloadFailed("We don't allow copyrighted content to download !");
        }
    }
}
