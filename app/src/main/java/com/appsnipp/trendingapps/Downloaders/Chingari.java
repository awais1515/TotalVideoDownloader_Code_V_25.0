...
public class Chingari extends Base {
    ...
    public Chingari(Context c, AsyncResponse asyncResponse)
    {
    ...
    public void onPostExecute(Document document)
    {
        try
        {
            ...
            if(! this.videoUrl.equals("") && this.videoUrl !=null )
            {
                ...
                sb.append(mainContext.getResources().getString(R.string.Chingari_Suffix));
                sb.append(System.currentTimeMillis());
                sb.append(".mp4");
                String str3 = Utils.RootDirectoryChingari;
