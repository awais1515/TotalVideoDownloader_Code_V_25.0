...
public class Twitter extends Base {
    public Twitter(Context c, AsyncResponse asyncResponse)
    {
    ...
    protected Document doInBackground(String... strings) {
        try {
            this.roposoDoc = Jsoup.connect("https://www.savetweetvid.com/downloader")
                    .data("url", strings[0])
                    .userAgent("Mozilla")
                    .post();
        } catch (IOException e) {
    ...
    public void onPostExecute(Document document)
    {
       try
       {
           ...
           if(! this.videoUrl.equals("") && this.videoUrl !=null )
           {
               ...
               sb.append(mainContext.getResources().getString(R.string.Twitter_Suffix));
               sb.append(System.currentTimeMillis());
               sb.append(".mp4");
               String str3 = Utils.RootDirectoryTwitter;
